...
INTEGER_COLUMNS = {
    ...
    "latest_data_max_date_ticker_count",
    ...
    "latest_portfolio_holding_count",
...
PUBLIC_METADATA_KEYS = {
    ...
    "latest_portfolio_holding_count",
    "latest_portfolio_rebalance_date",
    "latest_portfolio_price_date_used",
    "latest_portfolio_weight_sum",
    "latest_portfolio_min_weight",
    "latest_portfolio_max_weight",
    "latest_portfolio_top5_weight",
    "latest_portfolio_effective_holdings",
    "latest_portfolio_adv_window",
    "latest_portfolio_min_adv",
    "latest_portfolio_min_adv_ticker",
    "latest_portfolio_median_adv",
    "latest_portfolio_weighted_adv",
    "latest_portfolio_capacity_5pct_adv",
    "latest_portfolio_capacity_10pct_adv",
    "latest_portfolio_capacity_limit_ticker",
    "latest_portfolio_period_count",
    "latest_portfolio_nonempty_period_count",
    "latest_portfolio_nonempty_coverage",
    "latest_portfolio_average_turnover",
    "latest_portfolio_latest_turnover",
    "latest_portfolio_capacity_note",
    "rebalance_frequency",
    "benchmark_tickers",
    "benchmark_label",
