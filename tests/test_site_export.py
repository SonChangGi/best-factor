...
class SiteExportTest(unittest.TestCase):
    def test_build_site_payload_schema_numeric_allowlist_and_freshness(self):
        ...
        self.assertEqual(payload["automation"]["primary_refresh_kst"], "09:00 Tue-Sat")
        self.assertIn("10:00 Tue-Sat stale/missing JSON only", payload["automation"]["fallback_refresh_kst"])
