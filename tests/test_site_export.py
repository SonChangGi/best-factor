...
class SiteExportTest(unittest.TestCase):
    def test_build_site_payload_schema_numeric_allowlist_and_freshness(self):
        ...
        self.assertIn("12:00", payload["automation"]["fallback_refresh_kst"])
        self.assertIn("15:00", payload["automation"]["fallback_refresh_kst"])
        self.assertIn("18:00", payload["automation"]["fallback_refresh_kst"])
